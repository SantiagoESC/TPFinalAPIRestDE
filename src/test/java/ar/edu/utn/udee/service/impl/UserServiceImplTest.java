...
class UserServiceImplTest {
    ...
    void getUserByDocumentNumberShouldCallRepository() {
        ...
        when(userRepository.findByDocumentNumber(USER_DOCUMENT_NUMBER)).thenReturn(Optional.of(expectedUser));
        UserResponseDTO userResponse = this.userService.getUserDTOByDocumentNumber(USER_DOCUMENT_NUMBER);
        assertEquals(expectedUser.getDocumentNumber(), userResponse.getDocumentNumber());
    }
